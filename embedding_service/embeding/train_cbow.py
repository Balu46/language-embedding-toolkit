...
def train_model(languages=None, data_type=None, batch_size=None):
    ...
    if data_type == 'words':
        from library.embedding_service.data.datasets.multilingual_dataset import MultilingualWordDataset
        dataset_class = MultilingualWordDataset
    else:
        from library.embedding_service.data.datasets.multilingual_dataset import MultilingualPhonemeDataset
